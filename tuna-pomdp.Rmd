...
fixed <- data.frame( K = K, C = NA, sigma_g = sigma_g, discount = discount, model = "ricker", 
                     precision = 0.0000001, memory = memory / mc.cores, timeout = 40000, timeInterval = 2000,
...
meta <- appl::meta_from_log(data.frame(model ="ricker", sigma_m = 0.1), log_dir) %>% arrange(r)
